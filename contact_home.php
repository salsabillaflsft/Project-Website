					...
					<div class="header_content d-flex flex-row align-items-center justify-content-center">
						...
						<nav class="main_nav">
							<ul class="d-flex flex-row align-items-center justify-content-start">
								<li class="active"><a href="./contact_home.php">Home</a></li>
								...
								<div class="col">
									<div class="home_content">
										...
										<div class="tickets_form_container">
											<!--<form action="./artists2.php" method="get" class="tickets_form">
												<div class="d-flex flex-md-row flex-column align-items-start justify-content-md-between justify-content-start">
													<div class="tickets_form_inputs d-flex flex-row align-items-start justify-content-between">
														<input type="text" name="cari" class="tickets_form_input" placeholder="Type the title song..." required="required">
													</div>
                                                    <input type="submit" value="search" class="tickets_form_button button">
			...
			<div class="home_social">
				<div class="d-flex flex-row align-items-center justify-content-start">
					...
					<div class="home_social_list">
						<ul class="d-flex flex-row align-items-center justify-content-start">
							<li><a href="#"><i class="fa-pinterest" aria-hidden="true"></i></a></li>
	...
	<footer class="footer">
		...
		<div class="footer_bar">
			<div class="container">
				<div class="row">
					<div class="col">
						<div class="copyright text-center"><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->  Yesyua Leon Christy 123180141 - Salsabilla Filsafati 123180144 <br>
