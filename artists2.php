					...
					<div class="col">
								...
								<div class="col-lg-6 artist_col">
									<div class="artist_content">
										<div class="artist_info">
											<div class="artist_name"><h1><a href="./khalid.php">Khalid</a></h1></div>
											...
											<div class="artist_store d-flex flex-row align-items-start justify-content-start flex-wrap">
												<div class="store"><a href="#"><img src="./music/mages/appstore.png" alt=""></a></div>
						...
						<div class="artist">
							<div class="row">
								...
								<div class="col-lg-6 artist_col">
									<div class="artist_content">
										<div class="artist_info">
											<div class="artist_name"><h1><a href="./mariah.php">Mariah Carey</a></h1></div>
											<div class="artist_text">
						...
						<div class="artist">
							<div class="row">
								...
								<!-- Artist Image -->
								<div class="col-lg-6">
									<div class="artist_image"><img src="./music/images/beyy.jpg" alt=""></div>
								</div>
								...
								<div class="col-lg-6 artist_col">
									<div class="artist_content">
										<div class="artist_info">
											<div class="artist_name"><h1><a href="./beyonce.php">Beyonce</a></h1></div>
											<div class="artist_text">
						...
						<div class="artist">
							<div class="row">
								...
								<div class="col-lg-6 artist_col">
									<div class="artist_content">
										<div class="artist_info">
											<div class="artist_name"><h1><a href="./childish.php">Childish Gambino</a></h1></div>
											<div class="artist_text">
			...
			<div class="row row-lg-eq-height">
				...
				<div class="col-lg-6 offset-lg-6">
					<div class="featured_artist_content">
						...
						<div class="button featured_artist_button"><a href="./artist.php">read more</a></div>
					</div>
				</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6 order-lg-2 order-1">
                    ...
                    if(isset($_GET['cari'])){
		              $cari = $_GET['cari'];
                    $query=mysqli_query($conn,"select * from ((song left join genre on song.id_genre=genre.id_genre) left join jenis on song.id_jenis=jenis.id_jenis) left join artist on jenis.id_artist=artist.id_artist order by chart asc where title like '%".$cari."%'"); 
                    }
                    else{
