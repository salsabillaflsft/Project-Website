			...
			<div class="row">
				...
				<div class="col-lg-6 artist_col order-lg-1 order-2">
					<div class="artist_image text-right">
						<img src="./music/images/marc.jpg" alt="">
						<img src="./music/images/marc.jpg" alt="">
					</div>
				</div>
                 <?php
                    include 'connect.php';
                    $query=mysqli_query($conn,"select * from ((song left join genre on song.id_genre=genre.id_genre) left join jenis on song.id_jenis=jenis.id_jenis) left join artist on jenis.id_artist=artist.id_artist WHERE artist_name = 'Mariah_Carey'"); ?>
				<!-- Artist Info -->
                ...
                <td> <a href=login_lyrics.php=<?php echo $data['id_song']?>>Lihat Lirik</a></td>
        <?php
        }
        ?>
        </tr>
				...
				<div class="col">
					<div class="video_container_outer">
						<div class="video_container">
							...
							<video id="vid1" class="video-js vjs-default-skin" controls data-setup='{ "poster": "images/video.jpg", "techOrder": ["youtube"], "sources": [{ "type": "video/youtube", "src": "https://youtu.be/0habxsuXW4g"}], "youtube": { "iv_load_policy": 1 } }'>
							</video>
						</div>
					</div>
				</div>
			...
			<div class="container">
				<div class="row">
					<div class="col text-center">
						...
						<!-- Logo -->
						<div class="logo">
							<a href="./coba.php" class="d-flex flex-row align-items-end justify-content-start">
								<span class="logo_bars d-flex flex-row align-items-end justify-content-between"><span></span><span></span><span></span><span></span><span></span></span>
								<span class="logo_text">Lipsync•</span>
							</a>
						</div>
