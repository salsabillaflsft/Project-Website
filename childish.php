			...
			<div class="row">
				...
				<div class="col-lg-6 artist_col order-lg-1 order-2">
					<div class="artist_image text-right">
						<img src="./music/images/child.jpg" alt="">
						<img src="./music/images/child.jpg" alt="">
					</div>
				</div>
                 <?php
                    include 'connect.php';
                    $query=mysqli_query($conn,"select * from ((song left join genre on song.id_genre=genre.id_genre) left join jenis on song.id_jenis=jenis.id_jenis) left join artist on jenis.id_artist=artist.id_artist WHERE artist_name = 'Childish_Gambino'"); ?>
				<!-- Artist Info -->
				...
				<div class="col">
					<div class="video_container_outer">
						<div class="video_container">
							...
							<video id="vid1" class="video-js vjs-default-skin" controls data-setup='{ "poster": "images/video.jpg", "techOrder": ["youtube"], "sources": [{ "type": "video/youtube", "src": "https://youtu.be/diLp6hUqvVk"}], "youtube": { "iv_load_policy": 1 } }'>
							</video>
						</div>
					</div>
				</div>
